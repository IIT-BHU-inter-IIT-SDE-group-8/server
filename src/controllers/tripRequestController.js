...
const updateCommunityRequestStatus = async(req, res, next) => {
...
module.exports = {
    ...
    createTripRequestObjects, deleteTripRequestObjectById, updateTripRequestObject, updateCommunityRequestStatus
}